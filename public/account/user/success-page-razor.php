...
<br><br><footer></footer>';
                $sms_message = "Purchased sharedigitalcard of " . $_SESSION['new_year'] . " plan @" . $amount . " and Invoice No: #INV" . $invoice_number;
               // $sendEmail = $manage->sendMail($invoice_name, "fahim@kubictechnology.in", $sms_message, $message);
...
<section class="content">
                ...
                <div class="success">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="success_msg_main_div_k text-center">
                            ...
                            <div>
                                <a href="my-subscription-plan.php" class="btn btn_success_btn_sub">
                                    View Invoice
                                </a>
                            </div>
                        </div>
  ...
  <i class="fa fa-times fa-stack-1x icon_checkmark_design"></i>
                            ...
                            <div>
                                <a href="plan-selection.php" class=" btn btn_success_btn_sub">
                                    CONTINUE
                                </a>
                            </div>
                        </div>
