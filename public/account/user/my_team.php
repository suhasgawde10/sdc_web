...
if (isset($_POST['btn_update_payment'])) {
    $checkbox = $_POST['txt_id'];
       $update = $manage->mu_addWalletamount($checkbox,$_POST['txt_amount'],$_POST['txt_remark']);
        $error1 = false;
        $errorMessage1 = "Payment Added Successfully";
}


if (isset($_GET['edit_id'])) {
    $form_data = $manage->getSpecificTeamProfileByUserId($security->decryptWebservice($_GET['edit_id']));
    if ($form_data != null) {
...
if (isset($_POST['btn_save'])) {
    ...
    if (isset($_POST['txt_contact']) && $_POST['txt_contact'] != "") {
        ...
        $result = $manage->mu_validateEditorContact($txt_contact);
        if ($result) {
            $error = true;
    ...
    if(!$error){
        ...
        if(!$error) {
            ...
            if (!$error) {
                ...
                $status = $manage->insertTeamProfile($txt_name, $removeFileSpace, $removeImgSpace);
                if ($status) {
                    $password = $security->encrypt(rand(1000,100000))."8523";
                    $type = "Editor";
                    $insert_login = $manage->addTeamLogin($status,$type,$txt_email,$txt_contact,$password);
                    if($insert_login){
                        $sms_message1 = "Dear " . ucwords($txt_name) . ", \nYou have been registered as a editor \nPlease login to your panel.\n\nURL:sharedigitalcard.com/login.php \nUsername=" . $txt_contact . "\nPassword=" . $password;
                        $subject = "ShareDigitalCard.com - Registered as a editor of admin";
...
if(isset($_GET['edit_id'])) {
    ...
    if (isset($_POST['btn_update'])) {
        ...
        if (isset($_POST['txt_contact']) && $_POST['txt_contact'] != "") {
            $txt_contact = $_POST['txt_contact'];
            $result = $manage->mu_validateEditorContactById($txt_contact, $edit_id);
            if ($result) {
                $error = true;
                $errorMessage .= "Contact number already exist.<br>";
            }
        ...
        if(!$error){
            ...
            if ($form_data['id_proof']=="") {
                ...
                if (!$error) {
                    ...
                    $status = $manage->updateTeamProfile($txt_name, $removeFileSpace, $removeImgSpace, $edit_id);
                    if ($status) {
                ...
                <div class="card">
                    <div class="body">
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            <fieldset>
                                <legend class="legend_font_size" align="left">Add Editor</legend>
                                <ul class="profile-ul">
                                    <li>
                                        <div class="width-prf">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input name="txt_name" class="form-control" placeholder="Enter Name"
                                                           value="<?php if(isset($_POST['txt_name'])){ echo $_POST['txt_name']; }elseif (isset($name)) echo $name; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div class="width-prf">
                                            <label class="form-label">Contact Number</label> <span class="required_field">*</span>
                                    ...
                                    <li>
                                        <div class="width-prf">
                                            <label class="form-label">Email</label> <span class="required_field">*</span>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <input type="email" name="txt_email" class="form-control"
                                                           ...
                                                           value="<?php if(isset($_POST['txt_email'])){ echo $_POST['txt_email']; }elseif(isset($email)) echo $email; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
        ...
        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="header">
                        <h2>
                            Manage Editor  <span class="badge"><?php
                        ...
                        <table id="dtHorizontalVerticalExample" class="table table-striped table-bordered table-sm " cellspacing="0"
                            ...
                            if ($get_result != null) {
                                while ($result_data = mysqli_fetch_assoc($get_result)) {
                                    $editor_password = str_replace('8523','',$result_data['password']);
                                    ?>
                                    <tr>
                                        <td>
                                            <?php
                                            echo $result_data['name']."<br>".$result_data['email']."<br>";

                                            $aadharFilePath = 'uploads/' . $result_data['email'] . '/id-proof/' . $result_data['id_proof'];
                                            echo  "Id Proof : ";
                                            if (file_exists($aadharFilePath) && $result_data['id_proof'] != ""){ echo '<a href="' . $aadharFilePath . '" target="_blank">Preview</a>'; }else{ echo "-"; }
                                            echo "<br>";
                                            echo  "Light bill : ";
                                            $lightFilePath = 'uploads/' . $result_data['email']. '/light-bill/' . $result_data['light_bill'];
                                            if (file_exists($lightFilePath) && $result_data['light_bill'] != ""){ echo '<a href="' . $lightFilePath . '" target="_blank">Preview</a>'; }else{ echo "-"; }

                                            ?>
                                        </td>
                                        <td><?php echo "username: ".$result_data['contact_no']."<br>"; ?><?php echo "password: ".$security->decrypt($editor_password);
                                            ?></td>
                                        <td>
                                            <label
                                                    ...
                                                    <ul class="dropdown-menu pull-right">
                                                        ...
                                                        <li>
                                                            <a onclick="return confirm('Are You sure you want to <?php echo $result_data['status'] == 1 ? 'Block' : 'Unblock'; ?>?');"
                                                               href="my_team.php?publishData=<?php echo $security->encryptWebservice($result_data['user_id']) ?>&action=<?php echo $result_data['status'] == 1 ? "Block" : "Unblock"; ?>"
                                                               class="<?php echo $result_data['status'] == 0 ? "fa fa-unlock" : "fa fa-ban"; ?>">
                                                                &nbsp;&nbsp;<?php echo $result_data['status'] == 1 ? "Block" : "Unblock"; ?></a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:void(0);" onclick="myModalFunction('<?php echo $result_data['user_id']; ?>')">
                                                                <i class="fas fa-edit"></i>&nbsp;&nbsp;Add Wallet amount</a>
                                                        </li>
                                                        <li>
                                                            <a href="view-wallet-history.php?user_id=<?php echo $security->encryptWebservice($result_data['user_id']) ?>">
                                                                <i class="fas fa-edit"></i>&nbsp;&nbsp;Wallet History</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
...
<button class="btn btn-success openmodal" type="button" data-toggle="modal"
        data-target="#myModal" style="display: none">Pay Amount
</button>
    ...
    <div class="modal-dialog cust-model-width">
        ...
        <div class="modal-content">
            <div class="modal-header cust-upi-madal">
                ...
                <h4 class="modal-title">Add Amount into Wallet</h4>
            </div>
                ...
                <div class="body">
                    <form id="upi_form_validation" method="POST" action="">
                        ...
                        <div>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input name="txt_amount" type="number" class="form-control"
                      ...
                      <!--  <div>
                        ...
                        <div class="form-group form_inline form-float">
                            <button class="btn btn-primary waves-effect form-control"
                                    name="btn_update_payment" type="submit">
                                Add Amount
                            </button>
                        </div>
                    </form>
