                    ...
                    <div class="card">
                        ...
                        <div class="body custom_filter_padding">
                            ...
                            <ul class="nav nav-tabs tab-nav-right marg-top-5" role="tablist">
                                ...
                                <li role="presentation"><a class="custom_nav_tab" href="not-interested.php" ><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Not Interested <span class="badge badge-success"><?php echo $not_interest_total_count ?></span></a></li>
                            </ul>
                            <!-- Tab panes -->
