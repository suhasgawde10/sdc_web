...
if($pending_lead_count >0){
    $done =  $manage->updateUserLeadCount("Update");
    if($done){
                    ...
                    <div class="card">
                        ...
                        <div class="body custom_filter_padding">
                            ...
                            <ul class="nav nav-tabs tab-nav-right marg-top-5" role="tablist">
                                <li role="presentation" class="active" ><a class="custom_nav_tab" href="#pending" data-toggle="tab"><i class="fa fa-flag"></i> Pending <span class="badge badge-success"><?php echo $pending_total_count; ?></span></a></li>
                                ...
                                <li role="presentation"><a class="custom_nav_tab" href="not-interested.php" ><i class="fa fa-exclamation-triangle"></i> Not Interested <span class="badge badge-success"><?php echo $not_interest_total_count ?></span></a></li>
                            </ul>
                            <!-- Tab panes -->
                            <div class="tab-content paddin-top-zero">
                                <div role="tabpanel" class="tab-pane fade in active " id="pending">
                                       <!-- <div class="header">
                                            <h2>
                                                Total Follow Up Leads <span class="badge"><?php
/*                                                    if (isset($leadcount)) echo $leadcount;
                                                    */?></span>
                                            </h2>
                                        </div>-->
                                        <div class="body">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> <form method="post" action="">
                                                                        <select id="set_status" name="set_status"
                                                                                ...
                                                                                class="form-control">
                                                                            <option <?php if (isset($result_lead_data['approve_status']) && $result_lead_data['approve_status'] == 'Pending') echo 'selected' ?>><i class="fa fa-clock" aria-hidden="true"></i> Pending</option>
