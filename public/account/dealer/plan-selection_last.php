...
//        exit;
        ...
        $user_start_date = $get_user_data['user_start_date'];
        $referral_code = $get_user_data['referer_code'];
                            ...
                            <div>
                                ...
                                <div class="">
                                    <button name="btn_submit" type="submit"
                                            class="btn btn-success pricing_btn form" style="margin: 0;"></button>
                                </div>
                            </div>
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.user_plan_status == 'trial') {
                    $('.pricing_btn').text('CLICK HERE TO GET FREE').attr({
                        'onclick': 'window.location.href="free-trial.php?user_id=<?php echo $_GET['user_id']; ?>"',
                        'type': 'button'
                    }).show();
                    $(".get_amount tbody").html(result.data);
                    /*return false*/
                } else {
                    $('.pricing_btn').text('Upgrade Now').show().removeAttr('onclick').attr('type', 'submit');
                    $(".get_amount tbody").html(result.data);
                    /*return false*/
                }
            }
