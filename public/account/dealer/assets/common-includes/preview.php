        ...
        <section class="about">
            <div class="content">
                <div class="about-content">
                    ...
                    <p>
                        Your Digital Card custom url link <a href="#">' . SHARED_URL.$session_custom_url_is.'</a> .Click here to view your Digital Card.
                    </p>
                </div>
...
<div class="col-md-12">
                ...
                <div class="form-line preview_holder">
                    <form action="" method="post">
                        ...
                        <input id="myInput" name="custom_url_preview" class="form-control preview_padding"
                               ...
                               value="<?php if (isset($_GET['custom_url_id'])){ echo $session_custom_url_is; }else{ echo SHARED_URL.$session_custom_url_is;} ?>">
                        <div class="edit_icon">
    ...
    <div class="col-md-2 preview_btn_margin">
        ...
        <a title="Preview" target="_blank" class="preview_button"
           href="../m/index.php?custom_url=<?php echo $session_custom_url_is; ?>">Live Preview</a>
    </div>
</div>
