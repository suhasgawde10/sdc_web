...
/*if (isset($_POST['request_send'])) {
    ...
    if (!$error) {
        ...
        $kubicContact = $global_contact;
        $sendSms = $manage->sendSMS($kubicContact, $message);
        if ($sendSms) {
            $error = false;
...
if (isset($_GET["card"])) {
    $card_value = $_GET["card"];
    if (isset($_GET['token']) && $_GET['token'] != '') {
        $token = "&token=" . $_GET['token'];
    } else {
        $token = '';
    }
    header('location:' . FULL_WEBSITE_URL . 'd/' . $card_value . $token);
}

$total_customer = $manage->totalCustomer();
$total_dealer = $manage->totalDealer();
$total_customer_count = $total_customer * 11;
$total_dealer_count = $total_dealer * 7;
...
<head>
    <!--- Basic Page Needs  -->
    <meta charset="utf-8">
    <title>Digital Business card maker - Free 5 days trial - Share Digital Card</title>
    <meta name="description"
          content="Create digital business card maker in mumbai india. digital business card free for 5 days.">
    <meta name="keywords"
          content="Online visiting card maker,Online digital card, digital business card, digital card, create business card, free demo, mumbai, india, verified and secure business card,create digital card,digital business card,digital card,digital card in mumbai,online digital card maker,digital visiting card,digital business card free,digital marketing business cards,digital visiting card free,digital anniversary card,digital birthday card maker,best digital business card app,free digital business card maker,smart digital business card">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <!-- Mobile Specific Meta  -->
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <!-- CSS -->
    <meta property="og:site_name" content="Share Digital Card">
    <meta property="og:title" content="Create your own online business digital card for free"/>
    <meta property="og:description"
          content="we make modern digital business and visiting card with attractive design helps you to share efficiently and faster."/>
    <meta property="og:image" itemprop="image" content="https://sharedigitalcard.com/assets/img/logo/favicon.png">
    ...
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,700&amp;amp">
</head>
...
<div class="phone_img hidden-lg hidden-md hidden-sm visible-xs">
    <a href="tel:<?php echo $global_contact; ?>" title="contact us:-<?php echo $global_contact; ?>"><img
            src="assets/img/phone.png" alt="digital card contact"></a>
</div>
        ...
        <div class="row">
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active">
                        <img src="assets/img/sidebar/new-slider/slider_combo.png"
                        ...
                        <img src="assets/img/sidebar/slider_combo.jpeg"
                ...
                <div class="item">
                        <img src="assets/img/sidebar/new-slider/slider2.png"
                             class="visible-lg visible-md visible-sm hidden-xs"
                    ...
                    <div class="item">
                        <img src="assets/img/sidebar/new-slider/slider1.png"
                             class="visible-lg visible-md visible-sm hidden-xs"
                             alt="online digital card maker" style="width:100%;" title="online digital card maker">
                        <img src="assets/img/sidebar/secondslideimage3.jpg"
                             class="hidden-sm visible-xs hidden-lg hidden-md"
...
<div id="projectFacts" class="sectionClass">
    <div class="fullWidth eight columns">
        ...
        <div class="projectFactsWrap">
            ...
            <div class="item wow fadeInUpBig animated animated" data-number="<?php echo $total_dealer_count ?>"
...
<section class="visible-lg visible-md visible-sm hidden-xs">
    <div class="container">
        <div class="col-md-12 contact-form form_padding search_form">
            ...
            <div class="col-md-4">
                <img src="assets/img/search.png" class="img img-fluid img-responsive search-img" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div id="delayedPopup" class="delayedPopupWindow">
            ...
            <div id="mc_embed_signup">
                <form action="" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form"
                    ...
                    <a href="register.php" title="digital business card"><img src="assets/img/warningcards.png"
                                                                              style="width: 100%"
                ...
                <ul class="timeline">
                    <li>
                        <div class="timeline-image">
                            <img class="img-circle img-responsive process-img" src="assets/img/process/register.png"
                    ...
                    <li class="timeline-inverted">
                        <div class="timeline-image">
                            <img class="img-circle img-responsive process-img" src="assets/img/process/ready.png"
                    ...
                    <li>
                        <div class="timeline-image">
                            <img class="img-circle img-responsive process-img" src="assets/img/process/share.png"
                    ...
                    <li class="timeline-inverted process-padding">
                        <div class="timeline-image process_margin_img">
                            <img class="img-circle img-responsive process-img" src="assets/img/process/transaction.png"
                                 alt="digital business card" title="digital business card">
                        </div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
...
<script>
    ...
    $("#number1").jQuerySimpleCounter({end: <?php echo $total_customer_count ?>, duration: 5000});
    $("#number2").jQuerySimpleCounter({end: 70, duration: 5000});
    $("#number3").jQuerySimpleCounter({end: 16, duration: 5000});
    $("#number4").jQuerySimpleCounter({end: <?php echo $total_dealer_count ?>, duration: 5000});
...
<!--            $("#bkgOverlay").delay(25000).fadeIn(400);-->
