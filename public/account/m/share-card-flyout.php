                                ...
                                <div class="body" id="review_data">
                                    ...
                                    <div class="form-model">
                                        <ul class="ul-chat-option">
                                            <li>
                                                <a target="_blank"
                                                    href="https://api.whatsapp.com/send?phone=&text=<?php if(isset($company_name) && $company_name !="") echo "*".urlencode(trim($company_name))."*"; ?>%0A%0APlease%20click%20on%20below%20link%20to%20check%20Digital%20Card.%0A<?php
                                                    echo $final_link;
                                                    ?>"><img
                                            ...
                                            <li>
                                                <a href="<?php echo get_url_param_for_mobile('unsaved-whatsapp.php'); ?>"><img
                                                        class="whats-app-logo"><img src="<?php echo $whatsapp_share_model_icon;?>"></a>
                                                <p>Unsaved</p>
                                            </li>
                                            <!-- <li><a href="<?php echo get_url_param_for_mobile('add-remove-row.php'); ?>"><img src="<?php echo $sms_model_icon;?>"></a>
                                                <p>SMS</p>
                                            </li> -->
                                            <li><a href="<?php echo get_url_param_for_mobile('qr_code.php'); ?>"><img src="<?php echo $qr_code_icon; ?>"></a>
                                                <p>Qr Code</p>
                                            </li>
                                            <!-- <li><a href="<?php echo get_url_param_for_mobile('share-email.php') ?>"><img src="<?php echo $email_model_icon;?>"></a>
                                                <p>Email</p>
                                            </li> -->
                                            <li class="other_apps"><a href="javascript:void(0);" class="share-btn">
                                                <img src="<?php echo FULL_MOBILE_URL ?>assets/images/icon/digital-marketing.png"></a>
                                                <p>Other apps</p>
                                            </li>
