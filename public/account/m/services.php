...
/*if($ServiceSectionStatus != 1){
    $redirect = get_url_param_for_mobile('products.php');
...
$get_section_theme = $manage->mdm_displaySectionTheme($user_id, "1");
...
<section>
    <div class="content-main">
        <div class="overlay">
            ...
            <div class="services-heading"><h3><?php echo $our_service; ?></h3></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="action_btn d-flex align-items-center mt_15 ">
                    <button class="btn_hover btn btn-info app_btn view_more_btn" <?php echo (isset($get_serv_reviews[0]) && $get_serv_reviews[0] == "0") ? 'id="submit_service"' : 'id="get_otp"'; ?>
