...
if (isset($_GET['custom_url'])) {
    ...
    $get_client_data = $manage->mdm_getDigitalCardDetails("client_review",$custom_url);
...
/*if($ClientSectionStatus != 1){
    $redirect = get_url_param_for_mobile('our-team.php');
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo FULL_MOBILE_URL; ?>assets/css/component.css"/>

</head>
<body data-swipeleft="our-team.php<?php echo get_all_get(); ?>" data-swiperight="gallery.php<?php echo get_all_get(); ?>">
        ...
        <div class="overlay">
          ...
          <!--  <div class="testimonial-heading">
            ...
            <div class="bank-up-div">
                <div class="card">
                    <ul class="nav nav-tabs sticky_tab" role="tablist" style="margin-bottom: 15px;">
                        <?php
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mt-10">
                                            <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="flyout_modal_button_review" style="display: inline-block">
                                                    <button class="btn btn-primary"><i class="fa fa-edit"></i> Write a review</button>
                                                </div>
                                                <div class="filter_review">
                                                    <select onchange="changeFilterOfReview(this.value)" class=" form-control">
                                            ...
                                            <!-- <?php /*if (isset($_SESSION['email'])) { */ ?> <a title="Add Service" class="fas add-icon-color fa-plus-circle" href="../user/testimonial.php"></a>
                                                --><?php /*} */ ?>
                                        </div>
                                ...
                                <div class="client-main scrollbar style-11">
                                    ...
                                    <?php }else{ ?>
                                        <div class="col-lg-12">
                                            <div class="col-lg-8 col-lg-offset-2">
                                                <div class="text-center no_data_found">
                                                    <img src="<?php echo FULL_MOBILE_URL; ?>assets/images/cliens.png">
...
<script>
    function changeFilterOfReview(val) {
        if(val == 'low'){
            $('.owl-margin').load('<?php echo get_url_param_for_mobile('testimonial.php'); ?>&type=low ul.ul_client_review');
        }else {
            $('.owl-margin').load('<?php echo get_url_param_for_mobile('testimonial.php'); ?>&type=high ul.ul_client_review');
        }
    }
</script>
<script>
