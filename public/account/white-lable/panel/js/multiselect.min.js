if (!m_helper)var m_helper = {
    removeNode: function (a) {
        ...
        return a || (a = {}), a.tag = 'input', a.attributes || (a.attributes = {}), a.attributes.autocomplete = 'off', this.create(a)
    }, checkbox: function (a) {
...
Multiselect.prototype = {
    _createUI: function () {
        ...
        var f = m_helper.checkbox({class: 'multiselect-checkbox', data: {val: b}}), g = m_helper.create({
            tag: 'span',
            class: 'multiselect-text'
        }), h = m_helper.create({tag: a}), j = m_helper.label();
        ...
        var b = function () {
            ...
            if (!c || '' == c)m_helper.show(document.querySelector('#' + a._getItemListIdentifier() + ' > span')), m_helper.show(document.querySelector('#' + a._getItemListIdentifier() + ' > hr')), m_helper.showAll(document.querySelectorAll('#' + a._getItemListIdentifier() + ' li')); else {
