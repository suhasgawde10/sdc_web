...
class ManageAdminApp
{
    ...
    public $privacyPolicyTable = "tb_privacy_policy";
    public $otherServiceTable = "tb_other_services";
    public $demoCardTable = "tb_democard";
    ...
    function adminLogin($email, $pass)
    {
        ...
        $sql_query = "select * from " . $this->dealerTable . " where status=1 and  email_id='" . $email . "' and password='" . $pass . "'";
...
//        exit;
    ...
    {
        $controller = new Controller();
        $sql_query = "update " . $this->dealerTable . " set password='" . $password . "',pass_status = 0 where email_id ='" . $email . "'";
    ...
    function resetUserPassword($old_password, $new_password)
    {
        ...
        if ($validOldPassword) {
            $updateQuery = "update " . $this->dealerTable . " set password='" . $new_password . "', pass_status = 1  where id='" . $_SESSION['id'] . "'";
...
//    DEALER START
    ...
    function getDealerFranchisePlan($id)
    {
        $controller = new Controller();
        $sql_query = "SELECT * FROM ".$this->franchiseTable." WHERE user_id = $id ";
        $result = $controller->genericSelectToIterate($sql_query);
        return $result;
    }
    ...
    function getAdminAuthentication($email)
    {
        $controller = new Controller();
        $sql_query = "SELECT * FROM tb_dealer WHERE email_id = '$email'   LIMIT 1";
        $result = $controller->genericSelectAlreadyIterated($sql_query);
        return $result;
    }
    function updateFranchisePlan($user_id,$plan_name,$plan_price)
    {
        $controller = new Controller();
        $sql_query = "UPDATE franchise_price SET plan_price= $plan_price WHERE user_id = $user_id and plan_name ='$plan_name' ";
        $result = $controller->genericInsertUpdateDelete($sql_query);
        return $result;
    }
    function updateFranchiseStatus($user_id,$status)
    {
        $controller = new Controller();
        $sql_query = "UPDATE tb_dealer SET franchise_status = $status WHERE id = $user_id ";
    ...
    {
        $controller = new Controller();
        $sql_query = "UPDATE tb_dealer SET plan_status = $status WHERE id = $user_id ";
    ...
    function updateThemeStatus($user_id,$status)
    {
        $controller = new Controller();
        $sql_query = "UPDATE tb_dealer SET theme_status = $status WHERE id = $user_id ";
    ...
    function updateTestimonialStatus($user_id,$status)
    {
        $controller = new Controller();
        $sql_query = "UPDATE tb_dealer SET testimonial_status = $status WHERE id = $user_id ";
    ...
    function updateTeamStatus($user_id,$status)
    {
        $controller = new Controller();
        $sql_query = "UPDATE tb_dealer SET team_status = $status WHERE id = $user_id ";
    ...
    function updatePrivacyPolicyStatus($user_id,$status)
    {
        $controller = new Controller();
        $sql_query = "UPDATE tb_dealer SET privacy_status = $status WHERE id = $user_id";
        $result = $controller->genericInsertUpdateDelete($sql_query);
        return $result;
    }
    function updateServiceStatus($user_id,$status)
    {
        $controller = new Controller();
        $sql_query = "UPDATE tb_dealer SET other_service_status = $status WHERE id = $user_id";
        $result = $controller->genericInsertUpdateDelete($sql_query);
        return $result;
    }
    function getDealerPrivacyPolicy($id)
    {
        $controller = new Controller();
        $sql_query = "SELECT * FROM ".$this->privacyPolicyTable." WHERE dealer_id = $id LIMIT 1";
        $result = $controller->genericSelectAlreadyIterated($sql_query);
        return $result;
    }
    function updatePrivacyPolicy($user_id,$policy)
    {
        $controller = new Controller();
        $sql_query = "UPDATE tb_privacy_policy SET privacy='$policy' WHERE dealer_id = $user_id ";
       /* echo $sql_query;
        exit;*/
        $result = $controller->genericInsertUpdateDelete($sql_query);
        return $result;
    }
    function getSpecificCardDataByDealer($id)
    {
        $controller = new Controller();
    ...
    function getSpecificCardDataExitsByDealer($id)
    {
        $controller = new Controller();
        $sql_query = "SELECT * FROM tb_democard WHERE id = $id ";
        $result = $controller->genericSelectAlreadyIterated($sql_query);
        return $result;
    }
    ...
    {
        $controller = new Controller();
        $sql_query = "SELECT * FROM " . $this->otherServiceTable . " where user_id = $id";
        $result = $controller->genericSelectToIterate($sql_query);
        return $result;
    }
    function getOtherServiceByUserId($id)
    {
        $controller = new Controller();
        $sql_query = "SELECT * FROM ".$this->otherServiceTable." WHERE user_id = $id ";
        $result = $controller->genericSelectAlreadyIterated($sql_query);
